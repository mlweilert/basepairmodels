...
def BPNet1000d9conv7(
    input_seq_len=3056, output_len=1000, num_bias_profiles=2, filters=64,
    num_dilation_layers=9, conv1_kernel_size=7, dilation_kernel_size=3,
    profile_kernel_size=7, num_tasks=2, use_attribution_prior=False,
    attribution_prior_params=None):
