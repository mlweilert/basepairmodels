...
def training_argsparser():
    ...
    parser.add_argument('--num_dilation_layers', type=int,
                        help="number of dilational layers to use in BPNet",
                        default=8)
    parser.add_argument('--conv1_kernel_size', type=int,
                        help="Kernel length for initial convolution from sequence",
                        default=21)
    parser.add_argument('--profile_kernel_size', type=int,
                        help="Kernel length for final convolution to profile",
                        default=75)
    ...
    parser.add_argument('--control-smoothing', default=[[1.5, 50]])
...
def fastpredict_argsparser():
    ...
    parser.add_argument('--control-smoothing', nargs='+',
                        ...
                        "of second control track", default=[1.0, 51])
...
def interpret_argsparser():
    ...
    parser.add_argument('--control-smoothing', nargs='+',
                        ...
                        "smoothing of the control", default=[1.0, 51])
